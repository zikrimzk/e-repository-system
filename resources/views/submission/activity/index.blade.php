        ...
        <div class="main-content app-content">
            <div class="container">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <h1 class="page-title fw-bold fs-24 mb-0">Activity Setting</h1>
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item">SOP</li>
                                <li class="breadcrumb-item">Activity</li>
                                <li class="breadcrumb-item active" aria-current="page">Activity Setting</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="card custom-card">
                    <div class="card-header">
                        <a class="btn btn-primary-transparent btn-sm me-2" data-bs-toggle="modal"
                            data-bs-target="#modalAdd">Add Activity</a>
                    </div>
                </div>
                <!-- End Admin Action -->
                ...
                <div class="row mb-5">
                        ...
                        <div class="modal-dialog modal-dialog-centered text-center" role="document">
                            <div class="modal-content modal-content-demo">
                                <div class="modal-header">
                                    <h6 class="modal-title">Activity</h6><button aria-label="Close" class="btn-close"
                                        data-bs-dismiss="modal"></button>
                                </div>
                                <!-- Start Form -->
                                <form action="{{ route('activityAddPost') }}" method="POST">
                                    @csrf

                                    <!-- Activity Name -->
                                    <div class="modal-body text-start">
                                        <div class="col-sm-12">
                                            <label for="input-placeholder" class="form-label ">Activity Name</label>
                                            <input type="text"
                                                class="form-control @error('act_name') is-invalid @enderror" name="act_name"
                    ...
                    <!-- Start Modal Update -->
                    @foreach ($act as $acts)
                        <div class="modal fade" id="modalUpdate{{ $acts->id }}">
                            <div class="modal-dialog modal-dialog-centered text-center" role="document">
                                <div class="modal-content modal-content-demo">
                                    <div class="modal-header">
                                        <h6 class="modal-title">Update Activity</h6><button aria-label="Close"
                                            class="btn-close" data-bs-dismiss="modal"></button>
                                    </div>

                                    <form action="{{ route('activityUpdatePost') }}" method="POST">
                                        @csrf
                                        <div class="modal-body text-start">
                                            <!-- Activity Name -->
                                            <div class="col-sm-12">
                                                <label for="input-placeholder" class="form-label ">Activity Name</label>
                                                <input type="hidden" name="id" value= "{{ $acts->id }}">
                                                <input type="text"
                                                    class="form-control @error('act_name') is-invalid @enderror"
                                                    name="act_name" id="input-placeholder" placeholder="Activity Name"
                                                    value= "{{ $acts->act_name }}">
                                                @error('act_name')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
