...
<html lang="en" dir="ltr" data-nav-layout="vertical" data-theme-mode="light" data-header-styles="light"
    data-menu-styles="color" data-toggled="close" data-nav-style="menu-hover" data-width="boxed" loader="enable">
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="../assets/images/brand-logos/e-RepoFav.png" type="image/x-icon">
...
<body>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="switcher-canvas" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header border-bottom">
            <h5 class="offcanvas-title text-default" id="offcanvasRightLabel">e-Repository Settings</h5>
        ...
        <div class="offcanvas-body">
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="d-grid canvas-footer">
                    <a href="javascript:void(0);" id="reset-all" class="btn btn-primary m-1">Reset</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Loader -->
    <div id="loader">
        {{-- <img src="../assets/images/media/loader.svg"> --}}
