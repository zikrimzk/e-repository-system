                    ...
                    <div class="modal fade" id="modalAccept-{{ $sub->actID }}{{ $sub->stuID }}">
                        <div class="modal-dialog modal-dialog-centered text-center" role="document">
                            <div class="modal-content modal-content-demo">
                                <form
                                    action="{{ route('mysvApproveSubmission', ['act' => $sub->actID, 'stud' => $sub->stuID]) }}"
                                    method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-header">
                                        <h6 class="modal-title">{{ $sub->actname }} Approval
                                            <small>({{ $sub->name }})</small>
                                        </h6><button type="button" aria-label="Close" class="btn-close"
                            ...
                            <div class="modal-content modal-content-demo">
                                <form
                                    ...
                                    <div class="modal-body text-start">
                                        ...
                                        <p class="text-muted mb-3">(<span class="text-danger fw-bold">*</span>) is
                                            required</p>
                                        <label for="" class="form-label">Comment <span
            ...
            $(document).ready(function() {
                ...
                $(function() {
                    var table = $('.data-table').DataTable({
                        ...
                        serverSide: true,
                        responsive: true,
                        ajax: "{{ route('mysvsubmissionApproval') }}",
                        columns: [{
                                data: 'DT_RowIndex',
                                name: 'DT_RowIndex',
                                searchable: false
