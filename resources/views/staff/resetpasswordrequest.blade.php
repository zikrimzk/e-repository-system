            ...
            <div class="row justify-content-center align-items-center authentication authentication-basic">
                <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <a href="{{ route('staff.login') }}" class="btn btn-primary-transparent btn-sm"><i class='bx bx-arrow-back align-middle me-1'></i> Back</a>
                    </div> 
                    <div class="card custom-card shadow-lg" style="background:transparent">
                        <div class="card-body p-5">
                            ...
                            <p class="mb-4 text-muted op-7 fw-normal text-center">Staff Reset Password</p>
                            <form action="{{ route('resetStaffPasswordMail') }}" method="POST">
                                @csrf
                                <div class="col-xl-12">
