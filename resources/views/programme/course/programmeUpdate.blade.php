        ...
        <div class="main-content app-content">
            <div class="container">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Update Programme</h1>
                        ...
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('programmeManagement') }}">Programme
                                        Setting</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Update Programme</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="card custom-card">
                        <form method="POST" action="{{ route('programmeUpdatePost', $programme->id) }}">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <!-- Programme Name -->
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <select class="form-select @error('prog_mode') is-invalid @enderror"
                                            ...
                                            @if ($programme->prog_mode == 'FT')
                                                <option value="FT" selected>Full-Time</option>
                                                <option value="PT">Part-Time</option>
                                            @elseif($programme->prog_mode == 'PT')
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <select class="form-select @error('fac_id') is-invalid @enderror" name="fac_id"
                                            id="faculty">
                                            @foreach ($fac as $f)
                                                @if ($f->id == $programme->fac_id)
                                                    <option value="{{ $f->id }}" selected>{{ $f->fac_name }}
                                                    </option>
                                                @else
